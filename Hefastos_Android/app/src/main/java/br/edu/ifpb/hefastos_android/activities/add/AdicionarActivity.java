...
public class AdicionarActivity extends AppCompatActivity {
    ...
    */
    ...
    public void escolhaOnClick(Button b) {
        ...
        switch (b.getId()) {
            case R.id.btAssunto:
                intent = new Intent(this, AddAssuntoActivity.class);
                startActivity(intent);
                break;
            case R.id.btDisciplina:
                intent = new Intent(this, AddDisciplinaActivity.class);
                startActivity(intent);
                break;
           /*
           case R.id.btQuestao:
                intent = new Intent(this, AddQuestaoAbertaActivity.class);
                startActivity(intent);
                break;
                */
        }
